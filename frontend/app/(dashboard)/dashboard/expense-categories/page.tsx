...
import { getExpenseCategories, deleteExpenseCategory } from "@/services/api/expense-categories";
    ...
    const columns: Column<ExpenseCategory>[] = [
        {
            ...
            render: (cat) => <div className="text-sm font-medium text-gray-900">#{cat.id}</div>,
        ...
        },
        {
            ...
            render: (cat) => <div className="text-sm font-semibold text-gray-900">{cat.name}</div>,
            className: "whitespace-nowrap",
        },
        {
            key: "actions",
            ...
            render: (cat) => (
                <div className="flex justify-end gap-3">
                    <PermissionGuard permission={PERMISSIONS.EXPENSE_CATEGORIES.VIEW}>
                        <Link
                            href={`/dashboard/expense-categories/${cat.id}`}
                    ...
                    <PermissionGuard permission={PERMISSIONS.EXPENSE_CATEGORIES.EDIT}>
                        <Link
                            href={`/dashboard/expense-categories/${cat.id}/edit`}
                    ...
                    <PermissionButton
                        permission={PERMISSIONS.EXPENSE_CATEGORIES.DELETE}
    ...
    return (
        <div className="space-y-6 bg-gray-50 min-h-full">
            <PageHeader
                ...
                action={
                    <PermissionGuard permission={PERMISSIONS.EXPENSE_CATEGORIES.CREATE}>
                        <Link
                            href="/dashboard/expense-categories/new"
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200">
                <div className="p-6 bg-gradient-to-r from-gray-50 to-white border-b border-gray-200">
                    <div className="space-y-4">
                        <SearchBar value={searchQuery} onChange={setSearchQuery} placeholder="Search expense categories..." />
                ...
                {isLoading && categories.length === 0 ? (
                    ...
                    <EmptyState
                        ...
                        description={searchQuery ? `No records match "${searchQuery}".` : "Create your first expense category."}
                        action={
                            !searchQuery ? (
                                <PermissionGuard permission={PERMISSIONS.EXPENSE_CATEGORIES.CREATE}>
                                    <Link href="/dashboard/expense-categories/new" className="inline-flex items-center gap-2 px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700">
                                        Create category
                                    </Link>
                                </PermissionGuard>
                            ) : undefined
                    ...
                    <>
                        <div className="overflow-x-auto">
                            <DataTable data={categories} columns={columns} rowKey={(cat) => `expense-category-${cat.id}`} striped />
                        </div>
                        <Pagination
