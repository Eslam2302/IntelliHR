...
export default function RolesPage() {
  ...
  const columns: Column<Role>[] = [
    ...
    },
    {
      ...
      render: (r) => {
        if (r.deleted_at) return <div className="text-sm text-gray-400 italic">Deleted</div>;
        return (
          <div className="flex items-center justify-end gap-3">
            ...
            <PermissionGuard permission={PERMISSIONS.ROLES.MANAGE}>
              <Link
                href={`/dashboard/roles/${r.id}/edit`}
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200">
        <div className="p-6 bg-gradient-to-r from-gray-50 to-white border-b border-gray-200">
          <div className="space-y-4">
            ...
            <SearchBar value={searchQuery} onChange={setSearchQuery} placeholder="Search roles..." />
        ...
        {isLoading && roles.length === 0 ? (
          ...
          <EmptyState
            title="No roles"
            description={searchQuery ? `No results for "${searchQuery}".` : "Create your first role."}
            action={
              !searchQuery ? (
                <PermissionGuard permission={PERMISSIONS.ROLES.MANAGE}>
                  <Link
          ...
          <>
            <div className="overflow-x-auto bg-white rounded-b-xl">
              <DataTable data={roles} columns={columns} rowKey={(r) => `role-${r.id}`} striped />
            </div>
            <Pagination
