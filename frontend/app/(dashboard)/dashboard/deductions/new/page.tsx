...
import { createDeduction } from "@/services/api/deductions";
...
import type { CreateDeductionData } from "@/services/api/deductions";
...
export default function NewDeductionPage() {
    ...
    const {
        ...
        isSubmitting,
        error,
    } = useEntityForm<Deduction, CreateDeductionData, CreateDeductionData>({
        initialData: {
        ...
        onSuccess: () => router.push("/dashboard/deductions"),
        validate: (data) => {
    ...
    return (
        <ProtectedPage permission={PERMISSIONS.DEDUCTIONS.CREATE}>
            <div className="max-w-2xl mx-auto space-y-6">
                <div>
                    <h1 className="text-3xl font-bold text-gray-900">Create deduction</h1>
                    <p className="text-gray-600 mt-1">Add a new deduction</p>
                </div>
                <FormContainer onSubmit={handleSubmit} error={error}>
                    ...
                    <FormField
                        ...
                        min={0}
                    />
                    <ActionButtons submitLabel="Create deduction" isSubmitting={isSubmitting} />
                </FormContainer>
            </div>
        </ProtectedPage>
    );
