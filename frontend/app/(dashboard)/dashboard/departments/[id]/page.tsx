...
import { getDepartment } from "@/services/api/departments";
...
export default function DepartmentViewPage() {
    ...
    const { data: department, isLoading, error } = useEntity<Department>({
    ...
    if (error || !department) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[400px] gap-4">
                ...
                <Link href="/dashboard/departments" className="text-indigo-600 hover:text-indigo-800 font-medium">
                    ← Back to list
                </Link>
            </div>
        );
                ...
                <PageHeader
                    ...
                    action={
                        <div className="flex items-center gap-3">
                            <Link href="/dashboard/departments" className="text-gray-600 hover:text-gray-900 font-medium">
                                ← Back to list
                            </Link>
